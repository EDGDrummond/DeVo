\begin{tikzpicture}
    ...
    \node(q)[below=of Q]{$g_1ks_2s_3P$};
    \node(r)[below=of R]{$g_1ks_2s_3P$};
    \node(s)[below=of S]{$g_1ks_2s_3P$};
    \node(t)[below=of T]{$g_1ks_2s_3P$};
    \node(u)[below=of U]{$g_2ks_2s_3P$};

    \node[squarednode](Q1)[below=of q]{$\overline{Q}$};
    \node[squarednode](R1)[right=2cm of Q1]{$\overline{R}$};
    \node[roundnode](node)[below=1.2cm of {$(Q1)!0.5!(R1)$}]{$g_1ks_2s_3P$};
    ...
    \node[roundnode](node2)[below=1.2cm of U1]{$g_2ks_2s_3P$};
