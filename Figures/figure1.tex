\begin{tikzpicture}
    ...
    %Nodes
    \node[squarednode](Q){$g_1s_1P+r_{1,1,1}s_1P + r_{1,1,2}P$};
    \node[roundnode](G1)[below=0.5cm of Q]{$g_1$};
    \node[squarednode] (R)[below=0.5cm of G1] {$g_1s_1P+r_{1,2,1}s_1P + r_{1,2,2}P$};

    \node[squarednode](S)[right=of G1]{$g_2s_1P+r_{2,1,1}s_1P + r_{2,1,2}P$};
